...
- macOS app complete: menu bar, event tap, composer, injector, caret-anchored panel, settings window (hotkey recorder, options, launch-at-login, AX status, try-it box), language hotkeys (⌃⇧1-4 default).
...
## Log
- 2026-09-14 — ⌃⌥1 clashed with ChatGPT on the user's Mac. Language modifier set now configurable (⌃⇧ default, ⌃⌥, ⌥⇧, ⌃⌥⌘) in Settings.
