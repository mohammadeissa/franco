...
- macOS app complete: menu bar, event tap, composer, injector, caret-anchored panel, settings window (hotkey recorder, options, launch-at-login, AX status, try-it box), language hotkeys.
