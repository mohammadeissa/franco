...
| Toggle | Global hotkey (default ⌘⇧A, configurable) + menu-bar click + per-language shortcut ⌃⇧1-4 (modifier set configurable) | Instant on/off so English typing is never affected |
